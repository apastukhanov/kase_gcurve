...
def plot_gcurve(tradedate:datetime, flag_renew_plot=True)->None:
    ...
    for kod, price in bonds:
        ...
        trades.loc[trades["Код"]==kod, ['Дни до погашения']] = int(b.get_duration(r, tradedate)) / 365
    ...
    sns.scatterplot(data=trades[['Дни до погашения', 'Yield, %']], x='Дни до погашения', y='Yield, %', marker="^", color="red")
